    ...
    <div class="p-1 md:p-3 flex flex-col justify-center items-center rounded-lg bg-white w-4/5 md:w-2/3">
      <div class="flex flex-col w-full px-1 md:px-5 lg:px-10">
        <div class="w-full flex justify-between">
          <div class="w-full">
            <p class="lg:flex-row text-2xl font-bold p-3 md:text-4xl font-DoHyeon">
              <span class="users">{{nickname}}</span>님의 리뷰
            </p>
          </div>
          ...
          <div class="flex w-full">
            ...
            <div class="flex w-1/2 flex-col justify-between p-5 sm:py-10">
              ...
              <div class="self-start flex flex-col gap-5">
                ...
                <span class="font-GowunDodum">작성일시 : {{ createdAt1 }}  {{ createdAt2 }}</span> 
                <span class="font-GowunDodum">최종 수정일시 :{{ updatedAt1 }}  {{ updatedAt2 }}</span> 
...
export default {
  ...
  computed: {
    ...
    updatedAt1() {
      return this.review.updated_at?.substr(0,10)
    },
    updatedAt2() {
      return  this.review.updated_at?.substr(11,8)
    },
  },
  methods: {
